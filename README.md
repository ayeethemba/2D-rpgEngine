...
at James Madison University, Spring 2026. Forked from [chaoaj/sp26_cs345_team03](https://github.com/chaoaj/sp26_cs345_team03).

![Player battling enemies in a side-scrolling level](assets/gameplay.gif)
...
```bash
git clone https://github.com/ayeethemba/2D-rpgEngine.git
```
